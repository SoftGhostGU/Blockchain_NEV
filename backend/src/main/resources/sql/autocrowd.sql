...
(
    ...
    `wallet_balance`         decimal(10, 2)                                                NULL DEFAULT 0.00,
    `bank_card`              varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL,
...
(
    ...
    `access_policy`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'IBE访问策略',
